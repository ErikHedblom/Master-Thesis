...
\theabstract{Många företag lägger mycket tid och resurser på att testa mjukvara. Vi har utvecklat en teknik för modelleringsspråket Modelica som välja ut tester. Utvärderingen av tekniken visar att vi har minska tiden för testning med 56 \% utan att försämra kvaliteten på testningen.}
