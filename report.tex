...
To improve the name lookup in the source tree all requires handling the modified instances of classes. That is unfeasible within our time frame and furthermore, that is what the instance tree is for. 
