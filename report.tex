...
Further we would like to thank Jonathan Kämpe and Jesper Mattsson at Modelon for helping us understand the OPTIMICA Compiler Toolkit  compiler and validate our dependency analysis.
...
\\ \hline
    ...
    & \multicolumn{1}{r}{197}
    & \multicolumn{1}{@{}l|}{files}
    & \multirow{3}{*}{\shortstack{2h 26m 35s \\ {[}2h 26m 29s, 2h 26m 41s{]}}}
    & \multirow{3}{*}{\shortstack{16.7s \\ {[}16.0s , 17.4s{]}}}
    & 88 \%
\\
    & \ref{fig:mslonemodel}
