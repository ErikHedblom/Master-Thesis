...
In this chapter we will describe how we have implemented the test selection in OCT. The solution is implemented both in Optimica Compiler Toolkit (OCT) and in Model Testing Toolkit. OCT produces the dependency graph and the Model Testing Toolkit interacts with the user and runs the reduced test suit.
