...
% TODO: Mabye this should be part of the implementation section? Or reformulated, Modeluca has no concept of classes but JModelica does. Shouled we introduce it?
...
\begin{itemize}
	\item The root library the class is in.
	\item The root library any of the other specified classes are in.
	\item The root library of, a library that are set to be included in the analysis
\end{itemize}
