...
\section{Goal}
%TODO: Correct to say that: we are goning to implement in the JModelica.org compiler when we acctually do it in OCT? Niklas thought that we should write about JModelica in the introduction
%TODO: Correct to say that: the goal is to give some Modelica models to the compiler, when it origanaly was files?
